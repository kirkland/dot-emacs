...
(global-set-key (kbd "C-c b b") 'buffer-ring-list-buffers)
(global-set-key (kbd "C-c b r") 'buffer-torus-list-rings)

(global-set-key (kbd "C-c b a") 'buffer-ring-add)
(global-set-key (kbd "C-c b d") 'buffer-ring-delete)

(global-set-key (kbd "C-c b f") 'buffer-ring-next-buffer)
(global-set-key (kbd "C-c b b") 'buffer-ring-prev-buffer)
(global-set-key (kbd "C-c b c") 'buffer-ring-cycle)

(global-set-key (kbd "C-c b n") 'buffer-torus-next-ring)
(global-set-key (kbd "C-c b p") 'buffer-torus-prev-ring)
